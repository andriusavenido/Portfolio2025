...
const Landing: React.FC = () => {
  return (
    <div className="flex flex-col items-center bg-pattern h-screen mx-4 sm:mx-8 md:mx-16 lg:mx-40 min-h-screen">
      <Navbar></Navbar>
      <div className="flex items-center justify-start h-96 text-center my-24 bg-gradient-to-l bg-[var(--background-950)]">
        <div className=" lg:block flex-1 hidden flex-grow w-full h-full items-center justify-center bg-background-950">
        ...
        <div className="flex flex-col gap-4 p-8 flex-1 bg-[var(--background)] rounded-2xl">
          ...
          <p className="lg:text-2xl md:text-xl sm:text-sm font-light">I'm a second year student and an aspiring software engineer who is always curious, learning, and adapting. I hope to make an impact in this industry.</p>
          <motion.button
